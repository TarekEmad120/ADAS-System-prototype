...
/**
 * Class generated from <tt>veins_inet/VeinsInetSampleMessage.msg:8</tt> by nedtool.
 * <pre>
 * class VeinsInetSampleMessage extends inet::FieldsChunk
 * {
 *     string roadId;
 *     string carId;        // ID of the car that made the accident
 *     double accidentX;    // X coordinate of the accident location
 *     double accidentY;    // Y coordinate of the accident location
 * }
 * </pre>
 */
class VeinsInetSampleMessage : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual double getAccidentX() const;
    virtual void setAccidentX(double accidentX);
    virtual double getAccidentY() const;
    virtual void setAccidentY(double accidentY);
};
